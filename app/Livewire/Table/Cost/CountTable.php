...
final class CountTable extends PowerGridComponent
{
    use WithExport;

    private $menuId = 507;
    public string $tableName = 'lpg-count-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Conteos_' . Carbon::now()->format('Y-m-d'))
                ->striped()
