...
final class AssignTable extends PowerGridComponent
{
    private int $menu_id = 505;
    use WithExport;

    public string $tableName = 'lpg-assign-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Asignaciones_' . Carbon::now()->format('Y-m-d'))
                ->striped()
