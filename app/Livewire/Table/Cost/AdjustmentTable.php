...
final class AdjustmentTable extends PowerGridComponent
{
    ...
    private $menuId = 504;
    public string $tableName = 'lpg-adjustment-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Ajustes_' . Carbon::now()->format('Y-m-d'))
                ->striped()
    ...
    public function actionsFromView($row): View
    {
        $buttons = [
            [
                'name' => 'Editar',
                'route' => 'adjustment.edit',
                'params' => ['adjustment' => $row->id],
                'color' => 'blue',
                'icon' => 'fa fa-edit',
                'type' => 'button',
                'active' => true
            ...
            [
                'name' => 'Adjuntos',
                'route' => 'adjustment.attachment.index',
                'params' => ['adjustment' => $row->id],
                'color' => 'yellow',
