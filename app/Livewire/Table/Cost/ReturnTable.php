...
final class ReturnTable extends PowerGridComponent
{
    private int $menu_id = 506;
    use WithExport;

    public string $tableName = 'lpg-return-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Retornos_' . Carbon::now()->format('Y-m-d'))
                ->striped()
