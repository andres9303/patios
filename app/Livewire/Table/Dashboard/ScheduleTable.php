...
namespace App\Livewire\Table\Dashboard;
...
{
    public string $tableName = 'dashboard-schedule-table';
    ...
    public function datasource(): Builder
    {
        return Schedule::query()
            ...
            ->whereRaw('DATE_ADD(schedules.date, INTERVAL schedules.days-3 DAY) <= ?', [Carbon::now()])
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Proyecto', 'project_name', 'projects.name')
                ->sortable()
                ->searchable(),
            Column::make('Fecha ult Prg', 'date', 'schedules.date')
                ->sortable()
                ->searchable(),
            Column::make('Días', 'days', 'schedules.days')
                ->sortable()
                ->searchable(),
            Column::make('Fecha prox Prg', 'date2', 'schedules.date2')
                ->sortable()
                ->searchable(),
