...
final class Traking3Table extends PowerGridComponent
{
    public string $tableName = 'lpg-tracking3-table';
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('Tickets3_'.Carbon::now()->format('Y-m-d'))
                ->striped()
