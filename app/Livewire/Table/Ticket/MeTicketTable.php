...
final class MeTicketTable extends PowerGridComponent
{
    public string $tableName = 'lpg-me-ticket-table';
    use WithExport;
    ...
    public function actionsFromView($row): View
    {
        $buttons = [
            [
                'name' => 'Editar',
                'route' => 'me-ticket.edit',
                'params' => ['me_ticket' => $row->id],
                'color' => 'blue',
                'icon' => 'fa fa-edit',
                'type' => 'button',
                'active' => true
            ...
            [
                'name' => 'Adjuntos',
                'route' => 'me-ticket.attachment.index',
                'params' => ['me_ticket' => $row->id],
                'color' => 'yellow',
