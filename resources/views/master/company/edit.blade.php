<x-app-layout>
    <x-slot name="header">
        Maestros - Centros de costos - Editar Centros de costos
    </x-slot>
            ...
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    <div class="bg-gray-50 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4">
                            {!! html()->form('PUT', route('company.update', ['company' => $company]))->open() !!}
                            @include('master.company.components.form-elements')
                            @if ($errors->any())
