<x-app-layout>
    <x-slot name="header">
        Costos - Conteo de Inventario - {{ $count->num }} - {{ $count->date }} - Adjuntos
    </x-slot>
    ...
    <x-crud-index>
        ...
        <x-slot name="content">
            <div class="mt-8">
                <livewire:component.attachment-upload :attachmentable-type="App\Models\Doc::class" :attachmentable-id="$count->id" />
            </div>
        </x-slot>
    </x-crud-index>
</x-app-layout>