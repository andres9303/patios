<x-app-layout>
    <x-slot name="header">
        Costos - Salidas de Inventario - {{ $output->num }} - {{ $output->date }} - Adjuntos
    </x-slot>
    ...
    <x-crud-index>
        ...
        <x-slot name="content">
            <div class="mt-8">
                <livewire:component.attachment-upload :attachmentable-type="App\Models\Doc::class" :attachmentable-id="$output->id" />
            </div>
        </x-slot>
    </x-crud-index>
</x-app-layout>