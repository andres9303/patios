...
<body style="background-color: #f5f5f5; font-family: Arial, sans-serif; margin: 0; padding: 20px; text-align: center;">
    ...
    <div style="max-width: 600px; background-color: #ffffff; padding: 20px; margin: auto; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <!-- Título -->
        <h2 style="color: #333;">Se te ha asignado el ticket Nro. {{ $numTicket }}</h2>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tr>
                <td style="text-align: left; padding: 10px; border-bottom: 1px solid #ddd;"><strong>Solicitante:</strong></td>
                <td style="text-align: left; padding: 10px; border-bottom: 1px solid #ddd;">{{ $name }}</td>
            </tr>
            <tr>
