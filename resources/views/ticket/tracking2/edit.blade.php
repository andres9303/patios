<x-app-layout>
    <x-slot name="header">
        Tickets - Editar Seguimiento Informativo - {{ $resolve_2ticket->date }}
    </x-slot>
        ...
        <x-slot name="content">
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    {!! html()->form('PUT', route('resolve-2ticket.update', ['ticket' => $ticket->id, 'resolve_2ticket' => $resolve_2ticket]))->open() !!}
