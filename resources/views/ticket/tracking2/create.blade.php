<x-app-layout>
    <x-slot name="header">
        Tickets - Crear Seguimiento Informativo - Ticket #{{ $ticket->id }}
    </x-slot>
        ...
        <x-slot name="content">
            <div class="flex justify-center mt-8">
                <div class="w-full md:w-1/2">
                    {!! html()->form('POST', route('resolve-2ticket.store', $ticket->id))->open() !!}
                        @include('ticket.tracking2.components.form-elements')
                        @if ($errors->any())
