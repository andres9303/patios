        ...
        <x-slot name="content">
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="mb-4">
                    {!! html()->form('put', route('user.updatePassword', ['user' => $user]))->open() !!}
                        <div class="">
                            <div class="mt-4">
                                {!! html()->label('Contraseña', 'password')->class('block font-medium text-sm text-gray-700') !!}
                            ...
                            <div class="mt-4">
                                {!! html()->label('Confirmar contraseña', 'password_confirmation')->class('block font-medium text-sm text-gray-700') !!}
                        ...
                        <div class="mt-6">                  
                            {!! html()->button('<i class="fa fa-save"></i> Actualizar contraseña')
                                ->type('submit')
