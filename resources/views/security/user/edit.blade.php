        ...
        <x-slot name="content">
            <div class="flex justify-center">
                <div class="w-full md:w-1/2">
                    <div class="mb-4">
                        {!! html()->form('put', route('user.update', ['user' => $user]))->open() !!}
                            ...
                            <div class="mt-6">                  
                                {!! html()->button('<i class="fa fa-save"></i> Actualizar')
                                    ->attributes(['type' => 'submit', 'class' => 'bg-blue-500 block mt-1 w-full hover:bg-blue-600 text-white py-2 px-4']) !!}
                            </div>
                        {!! html()->form()->close() !!}
                    </div>
                </div>
